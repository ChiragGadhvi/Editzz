...
export function MovieCard({ movieId, overview, title, watchList, watchListId, youtubeUrl,age,time,year }: iAppProps) {
        ...
        <>
            ...
            <div className="p-5 absolute bottom-0 left-0 ">
                ...
                <div className="flex gap-x-2 items-center">
                    <p className="font-normal text-sm">{year}</p>sm
                    <p className="font-normal border py-0.5 px-1 border-gray-200 rounded text-">{age}+</p>
